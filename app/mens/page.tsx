...
async function getMensProducts(): Promise<ProductType[]> {
  await connectDB();

  const collection = await Collection.findOne({ name: "Mens" }).lean();
      ...
      <div className="max-w-7xl mx-auto px-4">
         <div className="mb-12 text-center">
          ...
          <p className="mt-3 text-gray-600 max-w-xl mx-auto">
            Stay stylish with our premium Mens essentials ❄️
          </p>
        </div>
